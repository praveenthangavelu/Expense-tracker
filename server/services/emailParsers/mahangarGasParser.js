...
export const parseMahanagarGas = ({ body, subject, date }) => {
  const result = { source: 'Mahanagar Gas', type: 'expense', category: 'Bills' };
  result.subCategory = 'Gas';
  ...
  result.merchant = 'Mahanagar Gas';
  result.date = date;
  result.referenceId = refMatch ? refMatch[1] : null;
  result.note = 'Mahanagar Piped Gas bill';
