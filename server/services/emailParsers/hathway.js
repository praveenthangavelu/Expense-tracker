...
export const parseHathway = ({ body, subject, date }) => {
  const result = { source: 'Hathway', type: 'expense', category: 'Bills' };
  ...
  result.merchant = 'Hathway';
  result.date = date;
  result.referenceId = refMatch ? refMatch[1] : null;
  result.note = 'Hathway broadband bill';
