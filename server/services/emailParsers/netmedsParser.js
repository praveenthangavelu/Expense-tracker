...
export const parseNetmeds = ({ body, subject, date }) => {
  const result = { source: 'Netmeds', type: 'expense', category: 'Health' };
  ...
  result.merchant = 'Netmeds';
  result.date = date;
  result.referenceId = refMatch ? refMatch[1] : null;
  result.note = 'Netmeds medicines';
