...
export const parseICICIBank = ({ body, subject, date }) => {
  const result = { source: 'ICICI Bank', type: 'expense', category: 'Other' };
  ...
  result.merchant = 'ICICI Bank';
  result.date = date;
  result.referenceId = refMatch ? refMatch[1] : null;
  result.note = 'ICICI transaction';
