...
export const parseHDFCBank = ({ body, subject, date }) => {
  const result = { source: 'HDFC Bank', type: 'expense', category: 'Other' };
  ...
  result.merchant = 'HDFC Bank';
  result.date = date;
  result.referenceId = refMatch ? refMatch[1] : null;
  result.note = 'HDFC transaction';
