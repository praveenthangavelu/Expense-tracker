...
export const parseKotakBank = ({ body, subject, date }) => {
  const result = { source: 'Kotak Bank', type: 'expense', category: 'Other' };
  ...
  result.merchant = 'Kotak Bank';
  result.date = date;
  result.referenceId = refMatch ? refMatch[1] : null;
  result.note = 'Kotak transaction';
