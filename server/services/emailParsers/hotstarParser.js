...
export const parseHotstar = ({ body, subject, date }) => {
  const result = { source: 'Hotstar', type: 'expense', category: 'Entertainment' };
  ...
  result.merchant = 'Hotstar';
  result.date = date;
  result.referenceId = refMatch ? refMatch[1] : null;
  result.note = 'Hotstar Premium';
