...
export const parseTataPower = ({ body, subject, date }) => {
  const result = { source: 'Tata Power', type: 'expense', category: 'Bills' };
  ...
  result.merchant = 'Tata Power';
  result.date = date;
  result.referenceId = refMatch ? refMatch[1] : null;
  result.note = 'Tata Power Electricity bill';
